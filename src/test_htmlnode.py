...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_to_html_props(self):
        ...
        The `props_to_html` method is then called on the `node` object and the resulting HTML string is compared to
        the expected value:
        - Expected HTML string: ' class="greeting" href="https://boot.dev"'

        This test ensures that the `props_to_html` method correctly converts the properties of the HTML node to the
    ...
    def test_to_html_no_children(self):
        ...
        The `to_html` method is then called on the `node` object and the resulting HTML string is compared to the
        expected value:
        - Expected HTML string: "<p>Hello, world!</p>"

        This test ensures that the `to_html` method correctly converts the `LeafNode` object to the corresponding
        HTML string when there are no children nodes.
    ...
    def test_to_html_no_tag(self):
        ...
        This test ensures that the `to_html` method correctly returns the content of the HTML node when the tag is
        `None`.
    ...
    def test_to_html_with_children(self):
        ...
        It then creates a `ParentNode` object with the tag name "div" and a list containing the child node,
        which is the created LeafNode.
        The `to_html` method is called on the `parent_node` object and the resulting HTML string is compared to the
        expected value:
        - Expected HTML string: "<div><span>child</span></div>"

        This test ensures that the `to_html` method correctly converts the `ParentNode` object to the corresponding
        HTML string when there are children nodes.
    ...
    def test_to_html_with_grandchildren(self):
        ...
        This test ensures that the `to_html` method correctly converts the `ParentNode` object to the corresponding
        HTML string when there are grandchildren nodes.
    ...
    def test_to_html_many_children(self):
        ...
        The `to_html` method is called on the `node` object and the resulting HTML string is compared to the expected
        value.
