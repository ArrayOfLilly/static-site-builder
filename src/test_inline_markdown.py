...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_delim_bold(self):
        ...
        This function creates a TextNode object with the text "This is text with a **bolded** word" and the
        text_type_text.
        It then calls the split_nodes_delimiter function with the created TextNode object and the delimiter "**" and
        text_type_bold.
    ...
    def test_delim_bold_double(self):
        ...
        This function creates a TextNode object with the text "This is text with a **bolded** word and **another**"
        and the text_type_text.
    ...
    def test_delim_italic(self):
        ...
        This function creates a TextNode object with the text "This is text with an *italic* word" and the
        text_type_text.
        It then calls the split_nodes_delimiter function with the created TextNode object and the delimiter "*" and
        text_type_italic.
        The function asserts that the returned list of new_nodes matches the expected list of TextNode objects.
    ...
    def test_delim_code(self):
        ...
        This function creates a TextNode object with the text "This is text with a `code block` word" and the
        text_type_text.
        It then calls the split_nodes_delimiter function with the created TextNode object and the delimiter "`" and
        text_type_code.
        The function asserts that the returned list of new_nodes matches the expected list of TextNode objects.
    ...
    def test_split_nodes_image_noimage(self):
        """
        Split nodes into text and image nodes and assert that the resulting list of nodes is equal to the expected
        list of nodes.
        ...
        node = TextNode(
                ...
                "https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png and another "
                "word",
                text_type_text,
                )
    ...
    def test_split_nodes_image_multiimage(self):
        ...
        node = TextNode(
                "This is text with an ![image]("
                "https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png) and another "
                "![second image](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/3elNhQu"
                ".png)",
                text_type_text,
                )
        new_nodes = split_nodes_image([node])
    ...
    def test_split_links(self):
        ...
        """
        node = TextNode(
                "This is text with a [link](https://boot.dev) and [another link](https://blog.boot.dev) with text "
                "that follows",
                text_type_text,
                )
    ...
    def test_text_to_textnodes(self):
        """
        Test the `text_to_textnodes` function by passing in a sample text string and asserting that the returned list
        of `TextNode` objects matches the expected list.

        This test case checks if the `text_to_textnodes` function correctly converts the given text string into a
        list of `TextNode` objects. It verifies that the function correctly identifies and formats different types of
        inline text, such as bold, italic, code, image, and link.
